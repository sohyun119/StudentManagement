		...
		<section class="d-flex justify-content-center mt-5">
			...
			<div id="signUpBox" class="border d-flex justify-content-center">
				<div id="signInnerBox" class="mt-4">
					...
					<div class="text-center text-secondary">선생님 회원가입</div>
					...
					<input type="text" id="subjectInput" class="form-control mt-3" placeholder="subject">
		...
		$(document).ready(function(){
			...
			$("#signUpBtn").on("click", function(){
				...
				$.ajax({
					type:"post",
					url:"/teacher/sign_up",
					data:{"loginId":loginId,"password":password, "name":name, "phoneNumber":phoneNumber, "address":address, "subject":subject},
